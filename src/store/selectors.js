...
// How to determine what was Ether/token value
...
export const orderBookSelector = createSelector(
    ...
    (orders) => {
        ...
        // Sort orders by orderType with more Lodash
...
const decorateOrderBookOrder = (order => {
    // How to check if it is a buy or sell order
...
// Turn all trades into series for price chart below
export const priceChartSelector = createSelector(
    ...
    (orders) => {
        ...
        [secondLastOrder, lastOrder] = orders.slice(orders.length - 2, orders.legth)
...
const buildGraphData = (orders) => {
    ...
    const graphData = hours.map((hour) => {
        ...
        // Calculates price values - OHLC
        const open = group[0] // first order
        // We can find the H/L with lodash
